...
The idea is to take the proportion of ratings for INSTR in (4, 5) for both serializations as a base line for a prediction in the FC model. 


```{r proportion of predictions}
...
It seems as if ratings == 4 are equal, so we can just use ratings == 5, which yields (74/(108+74)). Fed into the quantile function of the logistic distribution, it yields `r  qlogis(74/(108+74))`. `